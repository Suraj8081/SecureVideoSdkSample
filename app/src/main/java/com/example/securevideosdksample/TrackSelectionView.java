...
public class TrackSelectionView extends LinearLayout {
    ...
    public TrackSelectionView(
        ...
        disableView.setTextColor(context.getResources().getColor(R.color.black));
        ...
        defaultView.setTextColor(context.getResources().getColor(R.color.black));
    ...
    private void updateViews() {
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                trackView.setText(group.getFormat(trackIndex).height + "p");

             /*   if (MyApp.is_track_selector_auto.equalsIgnoreCase("0")) {
                    if (group.getFormat(trackIndex).height == 240) {
                        trackView.setText(180 + "p");
                    } else if (group.getFormat(trackIndex).height == 360) {
                        trackView.setText(240 + "p");
                    } else if (group.getFormat(trackIndex).height == 480) {
                        trackView.setText(360 + "p");
                    } else {
                        trackView.setText(group.getFormat(trackIndex).height + "p");
                    }
                } else {
